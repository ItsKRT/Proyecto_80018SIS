...
function iniciarSesion() {
  // Soporta tanto el menú navbar como el modal de login
  const nombre = (document.getElementById('loginNombre') && document.getElementById('loginNombre').value.trim()) ||
                 (document.getElementById('loginNombreModal') && document.getElementById('loginNombreModal').value.trim()) || '';
  const telRaw = (document.getElementById('loginTelefono') && document.getElementById('loginTelefono').value.trim()) ||
                 (document.getElementById('loginTelefonoModal') && document.getElementById('loginTelefonoModal').value.trim()) || '';
...
productos:[
  ...
  },
  {
    ...
    productos:[
      ...
      { nombre:'Sabritas Adobadas',         precio:20, precioOld:null, desc:'Papas fritas con adobo bolsa 45g. Sabor inigualable.',         img:'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=300', oferta:false },
      ...
      { nombre:'Doritos Flamin Hot',        precio:22, precioOld:null, desc:'Totopos sabor picante extremo bolsa 65g.',                    img:'https://images.unsplash.com/photo-1601700109060-8f5e2e3c4b0a?w=300', oferta:false },
      ...
      { nombre:'Oreo Doble Relleno',        precio:22, precioOld:null, desc:'Galletas Oreo con doble crema de vainilla 124g.',             img:'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=300', oferta:false },
      ...
      { nombre:'Palomitas Boing Caramelo',  precio:16, precioOld:20,   desc:'Palomitas dulces con caramelo bolsa 80g.',                   img:'https://images.unsplash.com/photo-1585647347483-22b66260dfff?w=300', oferta:true  },
      ...
      { nombre:'Cacahuates Enchilados',     precio:15, precioOld:null, desc:'Cacahuates con chile y limón bolsa 100g.',                   img:'https://images.unsplash.com/photo-1567892737950-30c4db39a5d4?w=300', oferta:false },
      { nombre:'Takis Fuego',               precio:24, precioOld:null, desc:'Totopos enrollados sabor fuego y limón bolsa 65g.',          img:'https://images.unsplash.com/photo-1601700109060-8f5e2e3c4b0a?w=300', oferta:false },
      { nombre:'Cheetos Flamin Hot',        precio:20, precioOld:null, desc:'Botanitas de maíz sabor picante 55g.',                       img:'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=300', oferta:false },
      { nombre:'Maná Nuez Mixta 150g',      precio:38, precioOld:45,   desc:'Mix de nueces tostadas y saladas bolsa 150g.',               img:'https://images.unsplash.com/photo-1567892737950-30c4db39a5d4?w=300', oferta:true  },
      { nombre:'Barcel Chips Habanero',     precio:22, precioOld:null, desc:'Papas estilo chips con habanero picante bolsa 45g.',         img:'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=300', oferta:false },
      { nombre:'Galletas Marías Gamesa',    precio:18, precioOld:null, desc:'Galletas tradicionales paquete 230g. Perfectas con café.',   img:'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=300', oferta:false },
      { nombre:'Galletas Surtidas Gamesa',  precio:22, precioOld:null, desc:'Surtido de galletas variadas paquete 270g.',                 img:'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=300', oferta:false },
      { nombre:'Gomitas Ricolino x200g',    precio:28, precioOld:null, desc:'Gomitas de sabores surtidos bolsa 200g.',                   img:'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=300', oferta:false },
    ]
  },
  {
    ...
    productos:[
      ...
      { nombre:'Leche Lala Semidescremada', precio:24, precioOld:null, desc:'Leche semidescremada pasteurizada 1 litro.',                  img:'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=300', oferta:false },
      { nombre:'Leche Sin Lactosa Lala 1L', precio:30, precioOld:null, desc:'Leche deslactosada para intolerantes 1 litro.',               img:'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=300', oferta:false },
      ...
      { nombre:'Yogurt Griego Fage 170g',   precio:28, precioOld:34,   desc:'Yogurt griego natural 0% grasa frasco 170g.',                img:'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=300', oferta:true  },
      { nombre:'Yoplait Fresa 125g',        precio:14, precioOld:null, desc:'Yogurt sabor fresa con frutas reales 125g.',                  img:'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=300', oferta:false },
      ...
      { nombre:'Queso Manchego Lala 200g',  precio:38, precioOld:null, desc:'Queso manchego rebanado listo para servir 200g.',             img:'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=300', oferta:false },
      { nombre:'Queso Panela Junco 400g',   precio:42, precioOld:null, desc:'Queso panela fresco bajo en grasa 400g.',                    img:'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=300', oferta:false },
      { nombre:'Queso Crema Philadelphia',  precio:55, precioOld:null, desc:'Queso crema para untar frasco 190g.',                        img:'https://images.unsplash.com/photo-1452195100486-9cc805987862?w=300', oferta:false },
      ...
      { nombre:'Margarina Primavera 90g',   precio:18, precioOld:null, desc:'Margarina vegetal para cocinar y untar 90g.',                 img:'https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=300', oferta:false },
      ...
      { nombre:'Crema Ácida Nestlé 200ml',  precio:20, precioOld:24,   desc:'Crema ácida espesa Nestlé ideal para tacos y sopas 200ml.',   img:'https://images.unsplash.com/photo-1578020190125-f4f7c18bc9cb?w=300', oferta:true  },
      { nombre:'Jocoque Lala 225g',         precio:22, precioOld:null, desc:'Jocoque seco listo para servir frasco 225g.',                 img:'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=300', oferta:false },
    ]
  },
  {
    ...
    productos:[
      { nombre:'Cloralex 950ml',              precio:30, precioOld:null, desc:'Blanqueador con aroma 950ml. Desinfecta y elimina gérmenes.',   img:'https://images.unsplash.com/photo-1609204782896-81c4a4e5b61f?w=300', oferta:false },
      { nombre:'Cloralex Multiusos Spray',    precio:28, precioOld:null, desc:'Blanqueador en spray listo para usar 500ml. Sin fregar.',       img:'https://images.unsplash.com/photo-1609204782896-81c4a4e5b61f?w=300', oferta:false },
      ...
      { nombre:'Fabuloso Frescura Activa 1L', precio:34, precioOld:null, desc:'Limpiador con tecnología de frescura activa 1 litro.',         img:'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=300', oferta:false },
      ...
      { nombre:'Ariel Líquido 1L',            precio:68, precioOld:80,   desc:'Detergente líquido concentrado 1 litro para ropa delicada.',   img:'https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=300', oferta:true  },
      { nombre:'Downy Suavizante 1.8L',       precio:72, precioOld:null, desc:'Suavizante de telas con aroma floral 1.8 litros.',             img:'https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=300', oferta:false },
      ...
      { nombre:'Salvo Lavatrastes Líquido',   precio:28, precioOld:null, desc:'Lavatrastes líquido limón 750ml. Corta grasa al instante.',    img:'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=300', oferta:false },
      { nombre:'Papel Higiénico Regio x4',   precio:45, precioOld:52,   desc:'Papel higiénico doble hoja paquete 4 rollos.',                 img:'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300', oferta:true  },
      { nombre:'Papel Higiénico Elite x12',  precio:95, precioOld:null, desc:'Papel higiénico elite suave paquete 12 rollos triple hoja.',   img:'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300', oferta:false },
      { nombre:'Toallas de Cocina Kirkland',  precio:55, precioOld:null, desc:'Toallas absorbentes para cocina rollo doble hoja.',            img:'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=300', oferta:false },
      { nombre:'Escoba Plástica',             precio:48, precioOld:null, desc:'Escoba de plástico con mango largo resistente.',              img:'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=300', oferta:false },
      { nombre:'Trapero Microfibra',          precio:65, precioOld:80,   desc:'Trapero de microfibra con mango telescópico 120cm.',          img:'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=300', oferta:true  },
      { nombre:'Bolsas de Basura x10',        precio:25, precioOld:null, desc:'Bolsas de basura negras resistentes 60L paquete 10 piezas.',  img:'https://images.unsplash.com/photo-1609204782896-81c4a4e5b61f?w=300', oferta:false },
      { nombre:'Desinfectante Pinol 1L',      precio:30, precioOld:null, desc:'Desinfectante de pisos pino 1 litro. Mata el 99.9% gérmenes.',img:'https://images.unsplash.com/photo-1583947215259-38e31be8751f?w=300', oferta:false },
      { nombre:'Limpiador WC Harpic 500ml',   precio:38, precioOld:45,   desc:'Limpiador de baño WC con ácido activo 500ml.',                img:'https://images.unsplash.com/photo-1609204782896-81c4a4e5b61f?w=300', oferta:true  },
      { nombre:'Esponja Scotch-Brite x3',     precio:28, precioOld:null, desc:'Esponjas duales para trastes paquete 3 piezas.',              img:'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=300', oferta:false },
    ]
  },
  {
    ...
    productos:[
      { nombre:'Atún Dolores Agua',           precio:20, precioOld:null, desc:'Atún en agua lata 140g. Rico en proteína.',                   img:'https://images.unsplash.com/photo-1534482421-64566f976cfa?w=300', oferta:false },
      { nombre:'Atún Dolores Aceite',         precio:22, precioOld:null, desc:'Atún en aceite de girasol lata 140g.',                        img:'https://images.unsplash.com/photo-1534482421-64566f976cfa?w=300', oferta:false },
      { nombre:'Atún Herdez 3 pack',          precio:55, precioOld:65,   desc:'Pack de 3 latas de atún en agua 140g cada una.',              img:'https://images.unsplash.com/photo-1534482421-64566f976cfa?w=300', oferta:true  },
      ...
      { nombre:'Elote Entero Del Fuerte 400g',precio:18, precioOld:null, desc:'Elote entero en almíbar lata 400g.',                          img:'https://images.unsplash.com/photo-1620706857370-e1b9770e8bb1?w=300', oferta:false },
      { nombre:'Champiñones La Costeña 280g', precio:22, precioOld:null, desc:'Champiñones en agua en lata listos para cocinar 280g.',       img:'https://images.unsplash.com/photo-1620706857370-e1b9770e8bb1?w=300', oferta:false },
      ...
      { nombre:'Frijoles Bayos Herdez 400g',  precio:18, precioOld:null, desc:'Frijoles bayos enteros en caldo lata 400g.',                  img:'https://images.unsplash.com/photo-1555244162-803834f70033?w=300', oferta:false },
      { nombre:'Salsa Tomate Herdez 210g',    precio:14, precioOld:null, desc:'Salsa de tomate para guisar lata 210g. Base ideal para salsas.',img:'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300', oferta:false },
      { nombre:'Chiles Chipotle La Costeña',  precio:16, precioOld:null, desc:'Chiles chipotles en adobo lata 199g. Sabor ahumado intenso.', img:'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300', oferta:false },
      ...
      { nombre:'Caldo de Pollo Knorr 230g',   precio:28, precioOld:34,   desc:'Caldo concentrado de pollo en lata 230g para sopas.',        img:'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300', oferta:true  },
      { nombre:'Durazno en Almíbar 820g',     precio:24, precioOld:null, desc:'Duraznos en almíbar lata 820g.',                             img:'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=300', oferta:false },
      { nombre:'Piña en Rodajas Del Monte',   precio:26, precioOld:null, desc:'Piña en rodajas en almíbar lata 565g.',                      img:'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=300', oferta:false },
      { nombre:'Sopa Campbell\'s Pollo',      precio:22, precioOld:null, desc:'Crema de pollo lista para servir lata 305g. Solo calienta.', img:'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300', oferta:false },
      { nombre:'Maíz Pozolero Maseca 800g',   precio:30, precioOld:36,   desc:'Maíz cacahuazintle precocido para pozole lata 800g.',        img:'https://images.unsplash.com/photo-1620706857370-e1b9770e8bb1?w=300', oferta:true  },
    ]
  },
  {
    ...
    productos:[
      { nombre:'Pan de Caja Bimbo Blanco',    precio:38, precioOld:null, desc:'Pan de caja blanco grande 680g. Suave y esponjoso.',           img:'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=300', oferta:false },
      { nombre:'Pan de Caja Bimbo Integral',  precio:40, precioOld:null, desc:'Pan integral con granos enteros 680g. Alto en fibra.',         img:'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=300', oferta:false },
      { nombre:'Pan Tostado Bimbo x8',        precio:28, precioOld:34,   desc:'Rebanadas de pan tostado crujiente paquete 8 piezas.',        img:'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=300', oferta:true  },
      ...
      { nombre:'Tortillas de Harina x10',     precio:28, precioOld:null, desc:'Tortillas de harina grandes paquete 10 piezas para burritos.',img:'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=300', oferta:false },
      ...
      { nombre:'Roles de Canela Marinela x4', precio:30, precioOld:null, desc:'Roles de canela con glaseado cremoso paquete 4 piezas.',     img:'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=300', oferta:false },
      { nombre:'Gansitos Marinela x3',        precio:18, precioOld:null, desc:'Pastelito de chocolate con fresa 3 piezas.',                 img:'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=300', oferta:false },
      { nombre:'Submarinos Marinela x6',      precio:32, precioOld:null, desc:'Bizcochitos de nata rellenos de crema 6 piezas.',            img:'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=300', oferta:false },
      ...
      { nombre:'Donas Bimbo Glaseadas x6',    precio:42, precioOld:50,   desc:'Donas suaves con glaseado de azúcar paquete 6 piezas.',     img:'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=300', oferta:true  },
      { nombre:'Cuernos Hojaldre Bimbo x4',   precio:35, precioOld:null, desc:'Cuernos de hojaldre mantequilla paquete 4 piezas.',          img:'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=300', oferta:false },
      { nombre:'Tostadas Charras x40',        precio:28, precioOld:null, desc:'Tostadas de maíz crujientes paquete 40 piezas.',             img:'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=300', oferta:false },
      { nombre:'Pan Árabe Pita x6',           precio:30, precioOld:null, desc:'Pan pita árabe suave listo para rellenar paquete 6 piezas.', img:'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=300', oferta:false },
      { nombre:'Bolillos Frescos x6',         precio:20, precioOld:null, desc:'Bolillos artesanales recién horneados paquete 6 piezas.',    img:'https://images.unsplash.com/photo-1598373182133-52452f7691ef?w=300', oferta:false },
    ]
  },
  {
    ...
    productos:[
      ...
      { nombre:'Jamón de Pavo Zwan 200g',      precio:38, precioOld:45,   desc:'Jamón de pavo bajo en grasa rebanado 200g.',                 img:'https://images.unsplash.com/photo-1612103198005-b238a0fa5d45?w=300', oferta:true  },
      { nombre:'Jamón Serrano Cien Montaditos', precio:85, precioOld:null, desc:'Jamón serrano importado rebanado fino 100g.',               img:'https://images.unsplash.com/photo-1612103198005-b238a0fa5d45?w=300', oferta:false },
      ...
      { nombre:'Salchicha Jumbo FUD x6',       precio:40, precioOld:null, desc:'Salchicha jumbo de cerdo empaque 6 piezas.',                 img:'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=300', oferta:false },
      { nombre:'Salchicha Hot Dog x10',        precio:32, precioOld:null, desc:'Salchichas estilo hot dog paquete 10 piezas.',               img:'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=300', oferta:false },
      { nombre:'Chorizo San Manuel 500g',      precio:55, precioOld:null, desc:'Chorizo rojo español artesanal 500g.',                      img:'https://images.unsplash.com/photo-1624623278313-a930126a11c3?w=300', oferta:false },
      { nombre:'Chorizo Verde Oaxaqueño',      precio:60, precioOld:72,   desc:'Chorizo verde artesanal oaxaqueño con hierbas frescas 400g.',img:'https://images.unsplash.com/photo-1624623278313-a930126a11c3?w=300', oferta:true  },
      ...
      { nombre:'Pepperoni San Rafael 100g',    precio:35, precioOld:null, desc:'Pepperoni rebanado para pizza 100g. Sabor americano.',       img:'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=300', oferta:false },
      { nombre:'Tocino Bud 200g',              precio:55, precioOld:null, desc:'Tocino de cerdo ahumado rebanado 200g. Perfectas tiras.',    img:'https://images.unsplash.com/photo-1612103198005-b238a0fa5d45?w=300', oferta:false },
      { nombre:'Pastrami Res Zwan 100g',       precio:48, precioOld:58,   desc:'Pastrami de res rebanado con especias 100g.',               img:'https://images.unsplash.com/photo-1612103198005-b238a0fa5d45?w=300', oferta:true  },
      { nombre:'Queso de Puerco Zwan 200g',    precio:32, precioOld:null, desc:'Queso de puerco ahumado rebanado 200g.',                    img:'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=300', oferta:false },
      { nombre:'Milanesa de Pollo x4',         precio:65, precioOld:null, desc:'Milanesas de pollo empanizadas listas para freír x4 pzas.', img:'https://images.unsplash.com/photo-1624623278313-a930126a11c3?w=300', oferta:false },
    ]
  },
  {
    ...
    productos:[
      { nombre:'Avena Quaker 1kg',             precio:45, precioOld:null, desc:'Avena en hojuelas integral 1kg. Desayuno nutritivo.',         img:'https://images.unsplash.com/photo-1614961233913-a5113a4a34ed?w=300', oferta:false },
      { nombre:'Avena Quaker Instantánea x8',  precio:38, precioOld:null, desc:'Sobres individuales de avena instantánea sabores surtidos.',  img:'https://images.unsplash.com/photo-1614961233913-a5113a4a34ed?w=300', oferta:false },
      ...
      { nombre:'Granola con Chocolate 400g',   precio:55, precioOld:65,   desc:'Granola con chips de chocolate oscuro y arándanos 400g.',    img:'https://images.unsplash.com/photo-1517686469429-8bdb88b9f907?w=300', oferta:true  },
      ...
      { nombre:'Mermelada Smucker\'s Fresa',   precio:38, precioOld:null, desc:'Mermelada de fresa premium frasco 340g. Sin conservadores.',  img:'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=300', oferta:false },
      ...
      { nombre:'Linaza Molida 300g',           precio:30, precioOld:null, desc:'Linaza molida lista para mezclar con jugos o yogurt 300g.',  img:'https://images.unsplash.com/photo-1571051740689-2b90a25661e2?w=300', oferta:false },
      { nombre:'Proteína Whey Chocolate',      precio:280,precioOld:320,  desc:'Proteína de suero de leche sabor chocolate 1kg.',            img:'https://images.unsplash.com/photo-1616671276441-2f2c277b8bf6?w=300', oferta:true  },
      { nombre:'Vitamina C 500mg x30',         precio:55, precioOld:null, desc:'Suplemento vitamina C tabletas frasco 30 piezas.',           img:'https://images.unsplash.com/photo-1616671276441-2f2c277b8bf6?w=300', oferta:false },
      { nombre:'Multivitamínico Centrum x30',  precio:120,precioOld:140,  desc:'Multivitamínico completo adultos frasco 30 tabletas.',       img:'https://images.unsplash.com/photo-1616671276441-2f2c277b8bf6?w=300', oferta:true  },
      { nombre:'Omega 3 x60 cápsulas',         precio:145,precioOld:null, desc:'Omega 3 aceite de pescado 1000mg cápsulas frasco 60 piezas.',img:'https://images.unsplash.com/photo-1616671276441-2f2c277b8bf6?w=300', oferta:false },
      { nombre:'Té Verde Lipton x20 sobres',   precio:38, precioOld:null, desc:'Té verde natural con antioxidantes caja 20 sobres.',         img:'https://images.unsplash.com/photo-1571051740689-2b90a25661e2?w=300', oferta:false },
      { nombre:'Té Manzanilla Grisi x25',      precio:30, precioOld:null, desc:'Manzanilla para relajar e infusionar caja 25 sobres.',       img:'https://images.unsplash.com/photo-1571051740689-2b90a25661e2?w=300', oferta:false },
      { nombre:'Almendras Naturales 200g',     precio:75, precioOld:90,   desc:'Almendras crudas sin sal bolsa 200g. Alto en vitamina E.',   img:'https://images.unsplash.com/photo-1567892737950-30c4db39a5d4?w=300', oferta:true  },
      { nombre:'Nuez de Castilla 150g',        precio:65, precioOld:null, desc:'Nuez de castilla sin cáscara bolsa 150g. Omega 3 natural.',  img:'https://images.unsplash.com/photo-1567892737950-30c4db39a5d4?w=300', oferta:false },
    ]
  },
  {
    ...
    productos:[
      ...
      { nombre:'Croquetas Pedigree 3kg',     precio:245, precioOld:280,  desc:'Alimento seco para perro adulto bolsa 3kg. Ahorra más.',  img:'https://images.unsplash.com/photo-1588943211346-0908a1fb0b01?w=300', oferta:true  },
      { nombre:'Croquetas Purina Dog Chow',  precio:110, precioOld:null, desc:'Alimento completo para perro adulto 1kg. Nutrición total.',img:'https://images.unsplash.com/photo-1588943211346-0908a1fb0b01?w=300', oferta:false },
      { nombre:'Alimento Húmedo Pedigree',   precio:18,  precioOld:null, desc:'Alimento húmedo pollo y res para perro lata 100g.',       img:'https://images.unsplash.com/photo-1588943211346-0908a1fb0b01?w=300', oferta:false },
      ...
      { nombre:'Croquetas Pro Plan Gato 1kg',precio:145, precioOld:160,  desc:'Alimento premium para gato adulto interior 1kg.',        img:'https://images.unsplash.com/photo-1574158622682-e40e69881006?w=300', oferta:true  },
      { nombre:'Alimento Húmedo Whiskas',    precio:16,  precioOld:null, desc:'Alimento húmedo de pollo para gato sobre 85g.',          img:'https://images.unsplash.com/photo-1574158622682-e40e69881006?w=300', oferta:false },
      ...
      { nombre:'Arena Aglomerante 4kg',      precio:85,  precioOld:100,  desc:'Arena aglomerante sin polvo control de olor 4kg.',       img:'https://images.unsplash.com/photo-1592194996308-7b43878e84a6?w=300', oferta:true  },
      { nombre:'Premio Snacks Perro 100g',   precio:35,  precioOld:null, desc:'Snacks masticables para perro bolsa 100g.',              img:'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=300', oferta:false },
      { nombre:'Premio Dental Perro Pedigree',precio:45, precioOld:null, desc:'Galletas dentales para higiene bucal canina 100g.',      img:'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=300', oferta:false },
      { nombre:'Juguete Cuerda Perro',       precio:65,  precioOld:80,   desc:'Juguete de cuerda colorido para perro mediano.',         img:'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=300', oferta:true  },
      { nombre:'Plato Acero Perro/Gato',     precio:45,  precioOld:null, desc:'Plato de acero inoxidable antideslizante 500ml.',        img:'https://images.unsplash.com/photo-1592194996308-7b43878e84a6?w=300', oferta:false },
      { nombre:'Shampoo Perro Suave 250ml',  precio:55,  precioOld:null, desc:'Shampoo suavizante con avena para perros 250ml.',        img:'https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=300', oferta:false },
    ]
  },
  ,{
