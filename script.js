...
[
  ...
  },
  {
    ...
    productos:
[
  { nombre:'Leche Alpura Entera 1L',    precio:25, precioOld:null, desc:'Leche entera pasteurizada 1 litro.',                          img:'W', oferta:false },
  { nombre:'Leche Lala Semidescremada', precio:24, precioOld:null, desc:'Leche semidescremada pasteurizada 1 litro.',                  img:'W', oferta:false },
  { nombre:'Leche Sin Lactosa Lala 1L', precio:30, precioOld:null, desc:'Leche deslactosada para intolerantes 1 litro.',               img:'W', oferta:false },
  { nombre:'Yogurt Danone Natural',     precio:12, precioOld:null, desc:'Yogurt natural sin azúcar 125g.',                            img:'W', oferta:false },
  { nombre:'Yogurt Griego Fage 170g',   precio:28, precioOld:34,   desc:'Yogurt griego natural 0% grasa frasco 170g.',                img:'W', oferta:true  },
  { nombre:'Yoplait Fresa 125g',        precio:14, precioOld:null, desc:'Yogurt sabor fresa con frutas reales 125g.',                  img:'W', oferta:false },
  { nombre:'Queso Oaxaca 400g',         precio:48, precioOld:55,   desc:'Queso de hebra artesanal 400g.',                             img:'W', oferta:true  },
  { nombre:'Queso Manchego Lala 200g',  precio:38, precioOld:null, desc:'Queso manchego rebanado listo para servir 200g.',             img:'W', oferta:false },
  { nombre:'Queso Panela Junco 400g',   precio:42, precioOld:null, desc:'Queso panela fresco bajo en grasa 400g.',                    img:'W', oferta:false },
  { nombre:'Queso Crema Philadelphia',  precio:55, precioOld:null, desc:'Queso crema para untar frasco 190g.',                        img:'W', oferta:false },
  { nombre:'Mantequilla Lala 200g',     precio:32, precioOld:null, desc:'Mantequilla sin sal barra 200g.',                            img:'W', oferta:false },
  { nombre:'Margarina Primavera 90g',   precio:18, precioOld:null, desc:'Margarina vegetal para cocinar y untar 90g.',                 img:'W', oferta:false },
  { nombre:'Crema Lala 200ml',          precio:18, precioOld:null, desc:'Crema ácida lista para servir 200ml.',                       img:'W', oferta:false },
  { nombre:'Crema Ácida Nestlé 200ml',  precio:20, precioOld:24,   desc:'Crema ácida espesa Nestlé ideal para tacos y sopas 200ml.',   img:'W', oferta:true  },
  { nombre:'Jocoque Lala 225g',         precio:22, precioOld:null, desc:'Jocoque seco listo para servir frasco 225g.',                 img:'W', oferta:false },
]
  },
  {
    ...
    productos:
[
  { nombre:'Cloralex 950ml',              precio:30, precioOld:null, desc:'Blanqueador con aroma 950ml. Desinfecta y elimina gérmenes.',   img:'W', oferta:false },
  { nombre:'Cloralex Multiusos Spray',    precio:28, precioOld:null, desc:'Blanqueador en spray listo para usar 500ml. Sin fregar.',       img:'W', oferta:false },
  { nombre:'Fabuloso Multiusos 1L',       precio:32, precioOld:38,   desc:'Limpiador líquido lavanda 1 litro.',                           img:'W', oferta:true  },
  { nombre:'Fabuloso Frescura Activa 1L', precio:34, precioOld:null, desc:'Limpiador con tecnología de frescura activa 1 litro.',         img:'W', oferta:false },
  { nombre:'Ariel Polvo 1kg',             precio:55, precioOld:null, desc:'Detergente en polvo con suavizante 1kg.',                      img:'W', oferta:false },
  { nombre:'Ariel Líquido 1L',            precio:68, precioOld:80,   desc:'Detergente líquido concentrado 1 litro para ropa delicada.',   img:'W', oferta:true  },
  { nombre:'Downy Suavizante 1.8L',       precio:72, precioOld:null, desc:'Suavizante de telas con aroma floral 1.8 litros.',             img:'W', oferta:false },
  { nombre:'Axion Lava Trastes',          precio:22, precioOld:null, desc:'Lavatrastes en pasta limón 500g.',                             img:'W', oferta:false },
  { nombre:'Salvo Lavatrastes Líquido',   precio:28, precioOld:null, desc:'Lavatrastes líquido limón 750ml. Corta grasa al instante.',    img:'W', oferta:false },
  { nombre:'Papel Higiénico Regio x4',    precio:45, precioOld:52,   desc:'Papel higiénico doble hoja paquete 4 rollos.',                 img:'W', oferta:true  },
  { nombre:'Papel Higiénico Elite x12',   precio:95, precioOld:null, desc:'Papel higiénico elite suave paquete 12 rollos triple hoja.',   img:'W', oferta:false },
  { nombre:'Toallas de Cocina Kirkland',  precio:55, precioOld:null, desc:'Toallas absorbentes para cocina rollo doble hoja.',            img:'W', oferta:false },
  { nombre:'Escoba Plástica',             precio:48, precioOld:null, desc:'Escoba de plástico con mango largo resistente.',              img:'W', oferta:false },
  { nombre:'Trapero Microfibra',          precio:65, precioOld:80,   desc:'Trapero de microfibra con mango telescópico 120cm.',          img:'W', oferta:true  },
  { nombre:'Bolsas de Basura x10',        precio:25, precioOld:null, desc:'Bolsas de basura negras resistentes 60L paquete 10 piezas.',  img:'W', oferta:false },
  { nombre:'Desinfectante Pinol 1L',      precio:30, precioOld:null, desc:'Desinfectante de pisos pino 1 litro. Mata el 99.9% gérmenes.',img:'W', oferta:false },
  { nombre:'Limpiador WC Harpic 500ml',   precio:38, precioOld:45,   desc:'Limpiador de baño WC con ácido activo 500ml.',                img:'W', oferta:true  },
  { nombre:'Esponja Scotch-Brite x3',     precio:28, precioOld:null, desc:'Esponjas duales para trastes paquete 3 piezas.',              img:'W', oferta:false },
]
  },
  {
    ...
    productos:
[
  { nombre:'Atún Dolores Agua',           precio:20, precioOld:null, desc:'Atún en agua lata 140g. Rico en proteína.',                   img:'W', oferta:false },
  { nombre:'Atún Dolores Aceite',         precio:22, precioOld:null, desc:'Atún en aceite de girasol lata 140g.',                        img:'W', oferta:false },
  { nombre:'Atún Herdez 3 pack',          precio:55, precioOld:65,   desc:'Pack de 3 latas de atún en agua 140g cada una.',              img:'W', oferta:true  },
  { nombre:'Chícharos Herdez 400g',       precio:15, precioOld:null, desc:'Chícharos en lata listos para servir 400g.',                  img:'W', oferta:false },
  { nombre:'Elote Entero Del Fuerte 400g',precio:18, precioOld:null, desc:'Elote entero en almíbar lata 400g.',                          img:'W', oferta:false },
  { nombre:'Champiñones La Costeña 280g', precio:22, precioOld:null, desc:'Champiñones en agua en lata listos para cocinar 280g.',       img:'W', oferta:false },
  { nombre:'Frijoles Isadora 440g',       precio:22, precioOld:28,   desc:'Frijoles refritos con manteca lata 440g.',                    img:'W', oferta:true  },
  { nombre:'Frijoles Bayos Herdez 400g',  precio:18, precioOld:null, desc:'Frijoles bayos enteros en caldo lata 400g.',                  img:'W', oferta:false },
  { nombre:'Salsa Tomate Herdez 210g',    precio:14, precioOld:null, desc:'Salsa de tomate para guisar lata 210g. Base ideal para salsas.',img:'W', oferta:false },
  { nombre:'Chiles Chipotle La Costeña',  precio:16, precioOld:null, desc:'Chiles chipotles en adobo lata 199g. Sabor ahumado intenso.', img:'W', oferta:false },
  { nombre:'Sardinas Calmex',             precio:18, precioOld:null, desc:'Sardinas en tomate lata 215g.',                               img:'W', oferta:false },
  { nombre:'Caldo de Pollo Knorr 230g',   precio:28, precioOld:34,   desc:'Caldo concentrado de pollo en lata 230g para sopas.',        img:'W', oferta:true  },
  { nombre:'Durazno en Almíbar 820g',     precio:24, precioOld:null, desc:'Duraznos en almíbar lata 820g.',                             img:'W', oferta:false },
  { nombre:'Piña en Rodajas Del Monte',   precio:26, precioOld:null, desc:'Piña en rodajas en almíbar lata 565g.',                      img:'W', oferta:false },
  { nombre:'Sopa Campbell\'s Pollo',      precio:22, precioOld:null, desc:'Crema de pollo lista para servir lata 305g. Solo calienta.', img:'W', oferta:false },
  { nombre:'Maíz Pozolero Maseca 800g',   precio:30, precioOld:36,   desc:'Maíz cacahuazintle precocido para pozole lata 800g.',        img:'W', oferta:true  },
]
  },
  {
    ...
    productos:
[
  { nombre:'Pan de Caja Bimbo Blanco',    precio:38, precioOld:null, desc:'Pan de caja blanco grande 680g. Suave y esponjoso.',           img:'W', oferta:false },
  { nombre:'Pan de Caja Bimbo Integral',  precio:40, precioOld:null, desc:'Pan integral con granos enteros 680g. Alto en fibra.',         img:'W', oferta:false },
  { nombre:'Pan Tostado Bimbo x8',        precio:28, precioOld:34,   desc:'Rebanadas de pan tostado crujiente paquete 8 piezas.',        img:'W', oferta:true  },
  { nombre:'Tortillas Maíz x30',          precio:22, precioOld:null, desc:'Tortillas de maíz empaque 30 piezas.',                        img:'W', oferta:false },
  { nombre:'Tortillas de Harina x10',     precio:28, precioOld:null, desc:'Tortillas de harina grandes paquete 10 piezas para burritos.',img:'W', oferta:false },
  { nombre:'Conchas Marinela x6',         precio:32, precioOld:38,   desc:'Pan dulce tradicional paquete 6 piezas.',                    img:'W', oferta:true  },
  { nombre:'Roles de Canela Marinela x4', precio:30, precioOld:null, desc:'Roles de canela con glaseado cremoso paquete 4 piezas.',     img:'W', oferta:false },
  { nombre:'Gansitos Marinela x3',        precio:18, precioOld:null, desc:'Pastelito de chocolate con fresa 3 piezas.',                 img:'W', oferta:false },
  { nombre:'Submarinos Marinela x6',      precio:32, precioOld:null, desc:'Bizcochitos de nata rellenos de crema 6 piezas.',            img:'W', oferta:false },
  { nombre:'Obleas Nestle x8',            precio:14, precioOld:null, desc:'Obleas con cajeta paquete 8 piezas.',                        img:'W', oferta:false },
  { nombre:'Donas Bimbo Glaseadas x6',    precio:42, precioOld:50,   desc:'Donas suaves con glaseado de azúcar paquete 6 piezas.',     img:'W', oferta:true  },
  { nombre:'Cuernos Hojaldre Bimbo x4',   precio:35, precioOld:null, desc:'Cuernos de hojaldre mantequilla paquete 4 piezas.',          img:'W', oferta:false },
  { nombre:'Tostadas Charras x40',        precio:28, precioOld:null, desc:'Tostadas de maíz crujientes paquete 40 piezas.',             img:'W', oferta:false },
  { nombre:'Pan Árabe Pita x6',           precio:30, precioOld:null, desc:'Pan pita árabe suave listo para rellenar paquete 6 piezas.', img:'W', oferta:false },
  { nombre:'Bolillos Frescos x6',         precio:20, precioOld:null, desc:'Bolillos artesanales recién horneados paquete 6 piezas.',    img:'W', oferta:false },
]
  },
  {
    ...
    productos:
[
  { nombre:'Jamón Virginia FUD 200g',       precio:42, precioOld:null, desc:'Jamón de pierna rebanado 200g.',                             img:'W', oferta:false },
  { nombre:'Jamón de Pavo Zwan 200g',       precio:38, precioOld:45,   desc:'Jamón de pavo bajo en grasa rebanado 200g.',                 img:'W', oferta:true  },
  { nombre:'Jamón Serrano Cien Montaditos', precio:85, precioOld:null, desc:'Jamón serrano importado rebanado fino 100g.',               img:'W', oferta:false },
  { nombre:'Salchicha FUD x8',              precio:36, precioOld:42,   desc:'Salchicha de pavo empaque 8 piezas.',                       img:'W', oferta:true  },
  { nombre:'Salchicha Jumbo FUD x6',        precio:40, precioOld:null, desc:'Salchicha jumbo de cerdo empaque 6 piezas.',                 img:'W', oferta:false },
  { nombre:'Salchicha Hot Dog x10',         precio:32, precioOld:null, desc:'Salchichas estilo hot dog paquete 10 piezas.',               img:'W', oferta:false },
  { nombre:'Chorizo San Manuel 500g',       precio:55, precioOld:null, desc:'Chorizo rojo español artesanal 500g.',                      img:'W', oferta:false },
  { nombre:'Chorizo Verde Oaxaqueño',       precio:60, precioOld:72,   desc:'Chorizo verde artesanal oaxaqueño con hierbas frescas 400g.',img:'W', oferta:true  },
  { nombre:'Mortadela Zwan 200g',           precio:30, precioOld:null, desc:'Mortadela rebanada fina 200g.',                             img:'W', oferta:false },
  { nombre:'Pepperoni San Rafael 100g',     precio:35, precioOld:null, desc:'Pepperoni rebanado para pizza 100g. Sabor americano.',       img:'W', oferta:false },
  { nombre:'Tocino Bud 200g',               precio:55, precioOld:null, desc:'Tocino de cerdo ahumado rebanado 200g. Perfectas tiras.',    img:'W', oferta:false },
  { nombre:'Pastrami Res Zwan 100g',        precio:48, precioOld:58,   desc:'Pastrami de res rebanado con especias 100g.',               img:'W', oferta:true  },
  { nombre:'Queso de Puerco Zwan 200g',     precio:32, precioOld:null, desc:'Queso de puerco ahumado rebanado 200g.',                    img:'W', oferta:false },
  { nombre:'Milanesa de Pollo x4',          precio:65, precioOld:null, desc:'Milanesas de pollo empanizadas listas para freír x4 pzas.', img:'W', oferta:false },
]
  },
  {
    ...
    productos:
[
  { nombre:'Avena Quaker 1kg',             precio:45, precioOld:null, desc:'Avena en hojuelas integral 1kg. Desayuno nutritivo.',         img:'W', oferta:false },
  { nombre:'Avena Quaker Instantánea x8',  precio:38, precioOld:null, desc:'Sobres individuales de avena instantánea sabores surtidos.',  img:'W', oferta:false },
  { nombre:'Granola Natural 500g',         precio:52, precioOld:null, desc:'Granola con frutos secos y miel 500g.',                       img:'W', oferta:false },
  { nombre:'Granola con Chocolate 400g',   precio:55, precioOld:65,   desc:'Granola con chips de chocolate oscuro y arándanos 400g.',    img:'W', oferta:true  },
  { nombre:'Miel Carlota 500g',            precio:62, precioOld:75,   desc:'Miel de abeja pura de campo 500g.',                          img:'W', oferta:true  },
  { nombre:'Mermelada Smucker\'s Fresa',   precio:38, precioOld:null, desc:'Mermelada de fresa premium frasco 340g. Sin conservadores.',  img:'W', oferta:false },
  { nombre:'Chía Orgánica 250g',           precio:38, precioOld:null, desc:'Semillas de chía orgánica 250g.',                            img:'W', oferta:false },
  { nombre:'Linaza Molida 300g',           precio:30, precioOld:null, desc:'Linaza molida lista para mezclar con jugos o yogurt 300g.',  img:'W', oferta:false },
  { nombre:'Proteína Whey Chocolate',      precio:280,precioOld:320,  desc:'Proteína de suero de leche sabor chocolate 1kg.',            img:'W', oferta:true  },
  { nombre:'Vitamina C 500mg x30',         precio:55, precioOld:null, desc:'Suplemento vitamina C tabletas frasco 30 piezas.',           img:'W', oferta:false },
  { nombre:'Multivitamínico Centrum x30',  precio:120,precioOld:140,  desc:'Multivitamínico completo adultos frasco 30 tabletas.',       img:'W', oferta:true  },
  { nombre:'Omega 3 x60 cápsulas',         precio:145,precioOld:null, desc:'Omega 3 aceite de pescado 1000mg cápsulas frasco 60 piezas.',img:'W', oferta:false },
  { nombre:'Té Verde Lipton x20 sobres',   precio:38, precioOld:null, desc:'Té verde natural con antioxidantes caja 20 sobres.',         img:'W', oferta:false },
  { nombre:'Té Manzanilla Grisi x25',      precio:30, precioOld:null, desc:'Manzanilla para relajar e infusionar caja 25 sobres.',       img:'W', oferta:false },
  { nombre:'Almendras Naturales 200g',     precio:75, precioOld:90,   desc:'Almendras crudas sin sal bolsa 200g. Alto en vitamina E.',   img:'W', oferta:true  },
  { nombre:'Nuez de Castilla 150g',        precio:65, precioOld:null, desc:'Nuez de castilla sin cáscara bolsa 150g. Omega 3 natural.',  img:'W', oferta:false },
]
  },
  {
    ...
    productos:
[
  { nombre:'Croquetas Pedigree 1kg',      precio:95,  precioOld:110,  desc:'Alimento seco para perro adulto 1kg.',                    img:'W', oferta:true  },
  { nombre:'Croquetas Pedigree 3kg',      precio:245, precioOld:280,  desc:'Alimento seco para perro adulto bolsa 3kg. Ahorra más.',  img:'W', oferta:true  },
  { nombre:'Croquetas Purina Dog Chow',   precio:110, precioOld:null, desc:'Alimento completo para perro adulto 1kg. Nutrición total.',img:'W', oferta:false },
  { nombre:'Alimento Húmedo Pedigree',    precio:18,  precioOld:null, desc:'Alimento húmedo pollo y res para perro lata 100g.',       img:'W', oferta:false },
  { nombre:'Croquetas Whiskas 500g',      precio:55,  precioOld:null, desc:'Alimento seco para gato adulto 500g.',                    img:'W', oferta:false },
  { nombre:'Croquetas Pro Plan Gato 1kg', precio:145, precioOld:160,  desc:'Alimento premium para gato adulto interior 1kg.',         img:'W', oferta:true  },
  { nombre:'Alimento Húmedo Whiskas',     precio:16,  precioOld:null, desc:'Alimento húmedo de pollo para gato sobre 85g.',           img:'W', oferta:false },
  { nombre:'Arena para Gato 5kg',         precio:75,  precioOld:null, desc:'Arena absorbente con control de olor 5kg.',               img:'W', oferta:false },
  { nombre:'Arena Aglomerante 4kg',       precio:85,  precioOld:100,  desc:'Arena aglomerante sin polvo control de olor 4kg.',        img:'W', oferta:true  },
  { nombre:'Premio Snacks Perro 100g',    precio:35,  precioOld:null, desc:'Snacks masticables para perro bolsa 100g.',               img:'W', oferta:false },
  { nombre:'Premio Dental Perro Pedigree',precio:45,  precioOld:null, desc:'Galletas dentales para higiene bucal canina 100g.',       img:'W', oferta:false },
  { nombre:'Juguete Cuerda Perro',        precio:65,  precioOld:80,   desc:'Juguete de cuerda colorido para perro mediano.',          img:'W', oferta:true  },
  { nombre:'Plato Acero Perro/Gato',      precio:45,  precioOld:null, desc:'Plato de acero inoxidable antideslizante 500ml.',         img:'W', oferta:false },
  { nombre:'Shampoo Perro Suave 250ml',   precio:55,  precioOld:null, desc:'Shampoo suavizante con avena para perros 250ml.',         img:'W', oferta:false },
]
  },
  {
